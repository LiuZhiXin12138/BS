...
//          alert(str);
  ...
  <%
    ...
    if (request.getParameter("selectName")!=null){
        sql += " where name='"+request.getParameter("selectName")+"'";
    }
...
//    }
    ...
    if ("delete".equals(request.getParameter("action"))){
        ...
        sql = "delete from friend where id='"+fId+"'";
    ...
    if ("modify".equals(request.getParameter("action"))){
      ...
      String phone = request.getParameter("modifyTel");
      String address = request.getParameter("modifyAdd");
      sql = "update friend set name='" + name + "',phone='" + phone + "',address = '" + address + "'" + "where id=" + id;
      conn.executeUpdate(sql);
      response.sendRedirect("index.jsp");
    }
  %>
...
<%--      <td><%=fMail%></td>--%>
  ...
  <div align="center" style="position:relative;top:10px">
    <button type="button" onclick="add()">添加联系人信息</button>
  </div>
  </body>
</html>
